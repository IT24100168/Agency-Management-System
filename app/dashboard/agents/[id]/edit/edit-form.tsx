...
import { agentFormSchema, type AgentFormValues } from "../../register/schema"
...
export default function EditAgentForm({ agent }: EditAgentFormProps) {
    ...
    const form = useForm<AgentFormValues>({
        ...
        defaultValues: {
            ...
            address: agent.contact_info?.address || "",
        },
    })
    ...
    return (
        <Card className="w-full max-w-2xl mx-auto">
            <CardHeader>
                ...
                <CardDescription>Update agent details.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
