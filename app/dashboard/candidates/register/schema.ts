...
export const candidateFormSchema = z.object({
    ...
    dob: z.string().refine((val) => !val || !isNaN(Date.parse(val)), { message: "Invalid date of birth" }).optional(),
    ...
    address: z.string().optional(),       // Full home address
    district: z.string().optional(),      // Sri Lanka district
    province: z.string().optional(),      // Sri Lanka province
    ...
    job_category_other: z.string().optional(),
    ...
    education_other: z.string().optional(),
